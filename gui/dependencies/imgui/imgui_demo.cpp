...
static void ShowDemoWindowTables()
{
    ...
    //   style.Colors[ImGuiCol_TableRowBg]          // Table row background when ImGuiTableFlags_RowBg is enabled (even width)
    //   style.Colors[ImGuiCol_TableRowBgAlt]       // Table row background when ImGuiTableFlags_RowBg is enabled (odds width)
    ...
    if (ImGui::TreeNode("Basic"))
    {
        ...
        // as TableNextColumn() will automatically wrap around and create new width as needed.
    ...
    if (ImGui::TreeNode("Row height"))
    {
        ...
        HelpMarker("Showcase altering CellPadding.y between width. Note that CellPadding.x is locked for the entire table.");
    ...
    if (ImGui::TreeNode("Angled headers"))
    {
        ...
        ImGui::SetNextItemWidth(ImGui::GetFontSize() * 8);
        ImGui::SliderInt("Frozen width", &frozen_rows, 0, 2);
        ...
        if (ImGui::TreeNode("Options"))
        {
            ...
            if (ImGui::TreeNodeEx("Other:", ImGuiTreeNodeFlags_DefaultOpen))
            {
                ...
                HelpMarker("If scrolling is disabled (ScrollX and ScrollY not set):\n"
                    ...
                    "- OuterSize.y then becomes the minimum size for the table, which will extend vertically if there are more width (unless NoHostExtendY is set).");
